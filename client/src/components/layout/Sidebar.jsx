...
import { LayoutDashboard, Users, Building2, CreditCard, Settings, LogOut, Zap, Megaphone, Code2, Radar, Mail } from 'lucide-react';
...
const nav = [
  ...
  { to: '/company-finder', icon: Radar, label: 'Company Finder' },
